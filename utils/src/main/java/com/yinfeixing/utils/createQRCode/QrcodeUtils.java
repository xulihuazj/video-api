package com.yinfeixing.utils.createQRCode;
...
/**
 * QrcodeUtils.java 1.0.0 2018-08-01  18:06
 * Copyright © 2014-2018,52mamahome.com.All rights reserved
 * history :
 * 1. 2018-08-01  18:06 @author
 */
public class QrcodeUtils {
    ...
    public static void main(String[] args) {
        try
        {
            System.out.println(getLogoQRCode("https://api.openpms.cn/internal/order/get/authCode?projectId=2", "乐璟社区"));
        }
        catch (Exception e)
        {
            e.printStackTrace();
    ...
    public static String getLogoQRCode(String qrUrl,String productName)
    {
        ...
        String filePath = "C:/Users/zjh/Desktop/favicon.png";  //TODO
    ...
    public String addLogo_QRCode(BufferedImage bim, File logoPic, LogoConfig logoConfig, String productName)
    {
        try
        {
            ...
            ImageIO.write(image, "png", new File("C:/Users/zjh/Desktop/"+ "test.png")); //TODO
